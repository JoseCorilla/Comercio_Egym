...
using WebComercio1.Areas.admin.Models;
using WebComercio1.Models;

namespace WebComercio1.Areas.admin.Controllers
{
    public class ProductoController : Controller
    {
        private WebComercioEntities db = new WebComercioEntities();
        ...
        {
            ViewBag.CategoriaId = new SelectList(db.Categoria, "CategoriaId", "Denominacion");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "ProductoId,CategoriaId,Denominacion,Descripcion,Precio,Existencias,Activo")] Producto producto)
        {
            ...
            ViewBag.CategoriaId = new SelectList(db.Categoria, "CategoriaId", "Denominacion", producto.CategoriaId);
            return View(producto);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ProductoId,CategoriaId,Denominacion,Descripcion,Precio,Existencias,Activo")] Producto producto)
        {
            if (ModelState.IsValid)
            {
